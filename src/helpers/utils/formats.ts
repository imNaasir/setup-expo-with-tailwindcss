...
const roundAmountBasedOnRules = (amount: number, numberFormat: string): number => {
    ...
    return parseFloat(amount.toFixed(4)); // Default to 4 decimal places
};
...
export const formatDigitsWithAbbreviation = (currency: CurrencyProps, amount: number, isPrefix = true) => {
